...
const PoolManagementComponent = () => {
    ...
    const handleAdd = () => {
        axios.post('https://localhost:7194/Fitness_App/AddPool', {
    ...
    const handleDelete = (id) => {
        axios.delete(`https://localhost:7194/Fitness_App/DeletePool/${id}`)
            .then(response => {
    ...
    const handleUpdate = () => {
        ...
        axios.put(`https://localhost:7194/Fitness_App/UpdatePool/${id}`, { Pool_name: name, Pool_depth: depth, Temp: temp })
            .then(response => {
    ...
    return (
        <div className="management">
            ...
            <h1>Swimming Trainer: {trainerName}</h1>
