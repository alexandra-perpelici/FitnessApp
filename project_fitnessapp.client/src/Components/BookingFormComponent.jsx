...
const BookingFormComponent = ({ onSubmit, userId, trainerId }) => {
    ...
    const handleFormSubmit = async () => {
        if (selectedDay && selectedHour) {
            ...
            try {
                const response = await axios.get(`https://localhost:7194/Fitness_App/GetBookingsByUserAndTrainer/${userId}/${trainerId}`);
    ...
    const getDisabledHours = () => {
        ...
        if (selectedDay === today.toISOString().split('T')[0]) {
            ...
            const previousHours = ["08:00", "09:00", "10:00", "11:00", "12:00", "13:00", "14:00","15:00", "16:00","17:00", "18:00", "19:00","20:00"];
