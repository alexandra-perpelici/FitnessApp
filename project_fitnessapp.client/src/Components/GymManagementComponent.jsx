...
const GymManagementComponent = () => {
    ...
    const handleAdd = () => {
        axios.post('https://localhost:7194/Fitness_App/AddEquipment', {
    ...
    const handleDelete = (id) => {
        axios.delete(`https://localhost:7194/Fitness_App/DeleteEquipment/${id}`)
            .then(response => {
    ...
    const handleUpdate = () => {
        ...
        axios.put(`https://localhost:7194/Fitness_App/UpdateEquipment/${id}`, { equipment_name, body })
            .then(response => {
                ...
                setEquipments(equipments.map(equipment => {
                    if (equipment.equipment_id === id) {
                        return { ...equipment, equipment_name, body };
                    }
                    return equipment;
                }));
