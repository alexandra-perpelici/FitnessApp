...
const ClimbingManagementComponent = () => {
    ...
    const fetchWalls = () => {
        ...
        axios.get('https://localhost:7194/Fitness_App/GetAllWalls')
    ...
    const handleAdd = () => {
        axios.post('https://localhost:7194/Fitness_App/AddWall', {
    ...
    const handleDelete = (id) => {
        axios.delete(`https://localhost:7194/Fitness_App/DeleteWall/${id}`)
            .then(response => {
    ...
    const handleUpdate = () => {
        ...
        axios.put(`https://localhost:7194/Fitness_App/UpdateWall/${id}`, { wall: wall, level: level })
            .then(response => {
